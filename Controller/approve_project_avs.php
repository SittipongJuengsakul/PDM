...
class Approve_project_avs extends UMS_Controller{
public function index(){
		...
		$this->load->model('PDM/m_approve_project_avs','u02');
		$data['form'] = $this->u02->select_data_form01($stdId)->result();
		$this->output('PDM/Approve/v_approve_project_avs',$data);
	}
	...
	$stdId=$this->session->userdata('UsPsCode');
		...
		//print_r($data['form']);
		$this->output('PDM/Form/v_form_dialog_u03',$data);
	}
