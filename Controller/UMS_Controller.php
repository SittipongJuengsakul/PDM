...
//		$this->load->model("UMS/m_umnotification"); for notification
	...
	function header()
	{
		...
		{																					
			$data['user'] = $this->m_umuser->get_by_id($this->session->userdata('UsID'))->row_array();
			*/
...
/*		}
		...
		{																					
			$data['workgroup'] = $this->m_umgroup->get_by_id($this->session->userdata('GpID'))->row_array();
		}
*/
