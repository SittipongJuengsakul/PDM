...
#padding {
    ...
    padding-left: 10px;
				...
				<div id="da-content-area">
                            <div class="grid_3">
                            <div class="da-panel" style="padding-bottom: 10px;">
							<div class="da-panel-header">
                                ...
                                <form action="<?php echo base_url();?>index.php/PDM/form_u02/insert_status/<?php echo 9;?>" method="get">
                                    ...
                                    <input type="button" class="da-button red"   style="float:left;" value="กลับ" OnClick="window.location.href = '<?php echo base_url();?>/index.php/PDM/form_u02/'">
                                    <input type="button" class="da-button red"   style="float:right;" value="ไม่อนุมัติแบบฟอร์มโครงงาน" OnClick="window.location.href = '<?php echo base_url();?>/index.php/PDM/form_u02/insert_statusfalse/<?php echo 2;?>/<?php echo $u02->frm1_id;?>'">
