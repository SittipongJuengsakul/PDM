                                 ...
                                 <center><div class="da-form-row">
                                                <div class="da-form-item large">
                                                    <select class="chzn-select" style="width:200px" name="year" onchange="location.href=this.value">
														...
														<option value="<?php echo base_url();?>index.php/PDM/search_project_avs?year=<?php echo $year=0; ?>">All</option>
                                                        <option value="<?php echo base_url();?>index.php/PDM/search_project_avs?year=<?php echo $year=date("Y")+1; ?>">
														<?php echo $cur_date+1;?>
														</option>
                                                        <option value="<?php echo base_url();?>index.php/PDM/search_project_avs?year=<?php echo $year=date("Y"); ?>">
														<?php echo $cur_date;?>
														</option>
														<?php for($c=1;$c<=10;$c++){?>
                                                        <option value="<?php echo base_url();?>index.php/PDM/search_project_avs?year=<?php echo $year=date("Y")-$c; ?>">
                                ...
                                <table id="da-ex-datatable-numberpaging" class="da-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="15%">ชื่อผู้รับผิดชอบ</th>
